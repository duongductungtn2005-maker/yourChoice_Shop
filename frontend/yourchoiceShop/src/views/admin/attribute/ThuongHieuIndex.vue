...
const exportExcel = async () => {
    const confirmRes = await Swal.fire({
        title: 'Xác nhận',
        text: 'Bạn có muốn tải xuống danh sách thương hiệu không?',
        icon: 'question',
...
const openModal = (item = null) => {
    if (item) {
        ...
        form.ten = item.tenThuongHieu; // Đổi thành tenThuongHieu
    ...
    try {
        ...
        if (isDuplicate) {
            Swal.fire({
                ...
                text: `Thương hiệu "${form.ten}" đã có trong hệ thống.`,
