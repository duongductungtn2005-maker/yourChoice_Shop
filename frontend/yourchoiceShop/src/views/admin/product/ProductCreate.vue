                    ...
                    <table class="custom-table">
                       ...
                       <tbody>
                          <tr v-for="variant in getVariantsByColor(color.id)" :key="variant.key">
                             ...
                             <td>
                                <input type="number" v-model="variant.giaBan" class="form-control-sm text-right text-price font-bold">
                             </td>
...
<style scoped>
/* GENERAL */
.create-product-page { font-family: 'Segoe UI', sans-serif; color: #334155; padding-bottom: 80px; /* Thêm padding dưới để không bị thanh bottom che */ background-color: #f8fafc; min-height: 100vh; padding: 20px; }
.header-section { display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; }
.text-bold { font-weight: 700; color: #0f172a; } .separator { margin: 0 8px; color: #cbd5e1; }
.btn { padding: 9px 20px; border-radius: 6px; font-weight: 600; cursor: pointer; transition: 0.2s; border: none; display: inline-flex; align-items: center; gap: 8px; }
...
.attr-label { width: 100px; font-weight: 600; color: #334155; }
...
/* VARIANT LAYOUT */
.variant-group-card { border: 1px solid #e2e8f0; border-radius: 8px; background: #fff; margin-bottom: 20px; overflow: hidden; box-shadow: 0 1px 2px rgba(0,0,0,0.05); }
...
.group-title { font-size: 14px; color: #0f172a; display: flex; align-items: center; }
...
.col-left-table { flex: 2; border-right: 1px solid #e2e8f0; padding: 0; }
.col-right-images { flex: 1; min-width: 340px ; background-color: #fff; display: flex; flex-direction: column; padding: 0; }

/* TABLE */
.custom-table { width: 100%; border-collapse: collapse; }
.custom-table th { text-align: left; font-size: 12px; color: #64748b; font-weight: 600; padding: 12px 15px; border-bottom: 1px solid #e2e8f0; background: #fff; }
.custom-table td { padding: 12px 15px; vertical-align: middle; border-bottom: 1px solid #f1f5f9; }
...
.text-price { color: #0f172a; font-weight: 600; }
.size-badge { background: #f1f5f9; padding: 4px 10px; border-radius: 4px; font-weight: 600; font-size: 12px; color: #475569; border: 1px solid #e2e8f0; }
...
/* IMAGE AREA */
.img-header-row { width: 100%; padding: 12px 15px; border-bottom: 1px solid #e2e8f0; font-size: 12px; font-weight: 600; color: #64748b; text-align: center; background: #fff; }
.image-content-wrap { flex: 1; display: flex; align-items: center; justify-content: center; padding: 20px; }
.image-upload-area { width: 100%; height: 100%; display: flex; justify-content: center; align-items: flex-start; flex-direction: column; }
.upload-placeholder { width: 100%; height: 120px; border: 2px dashed #cbd5e1; border-radius: 8px; display: flex; flex-direction: column; align-items: center; justify-content: center; cursor: pointer; color: #64748b; transition: all 0.2s; background: #f8fafc; }
...
.gallery-grid { display: flex; flex-wrap: wrap; justify-content: center; gap: 15px; width: 100%; }
.img-thumbnail { width: 100px; height: 100px; border-radius: 6px; overflow: hidden; border: 1px solid #e2e8f0; background: #fff; box-shadow: 0 2px 5px rgba(0,0,0,0.05); position: relative; transition: transform 0.2s; }
...
.add-image-tile { width: 100px; height: 100px; border: 2px dashed #cbd5e1; border-radius: 6px; display: flex; flex-direction: column; align-items: center; justify-content: center; cursor: pointer; background-color: #fff; color: #64748b; transition: all 0.2s; }
.add-image-tile:hover { border-color: #3b82f6; color: #3b82f6; background-color: #eff6ff; }
.tile-icon { font-size: 24px; margin-bottom: 5px; }
.tile-text { font-size: 12px; font-weight: 600; }

/* BULK & RESTORE BUTTONS */
.btn-bulk-edit-large, .btn-restore { padding: 8px 20px; font-size: 13px; font-weight: 600; border-radius: 6px; border: 1px solid #e2e8f0; transition: all 0.2s ease; display: inline-flex; align-items: center; gap: 8px; cursor: pointer; }
